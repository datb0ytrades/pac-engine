...
// --- Zod schemas para validación de entrada API ---
...
// Re-exports
export { validateDocument, calculateCufeLuhn } from './document-validator';
export type { ValidationRule } from './validation-codes';

// Legacy compatibility - keep the old simpler schemas
export const taxPayerSchema = grupoRucSchema;
export const createDocumentSchema = facturaElectronicaSchema;
